...
function App() {
  ...
  document.title = 'Kang, Hueben | MP1';
  ...
  return (
    <div className="App">
      <h1 className="header">Machine Problem 3</h1>
      <h1 className="header">Memory Management</h1>
      <div className='row'>
      {showButton && (
        <div className='row'>
      ...
      <div className='row'>
        ...
        <Table
          type={"System Performance Summary"}
